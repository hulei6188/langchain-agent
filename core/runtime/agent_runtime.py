...
def draft_agent_source(db: Session, agent: Agent) -> dict:
    ...
    return {
        ...
        "workflow": detail.get("workflow_graph") or detail.get("workflow") or default_workflow(),
...
def published_agent_source(db: Session, agent: Agent) -> dict:
    ...
    return {
        ...
        "workflow": snapshot.get("workflow_graph") or snapshot.get("workflow") or default_workflow(),
